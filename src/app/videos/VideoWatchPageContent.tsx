    ...
    <Box style={{ display: 'flex', minHeight: '99vh' }}>
                  ...
                  <Fade in={completed} timeout={400} unmountOnExit>
                    ...
                    >
                      ...
                      <Box sx={{ display: 'flex', alignItems: 'center' }}>
                        <CheckCircleIcon
                          sx={{ color: '#2ecc40', fontSize: 24, mr: 1 }}
                        />
                        <Typography
                          sx={{
                            color: '#218838',
      ...
      >
        ...
        {Object.entries(groupedVideos).map(([topic, vids]) => {
          const isTopicOfCurrentVideo = vids.some(
            (v) => v.shortcode === shortcode
          );
          ...
          return (
            ...
            >
              ...
              >
                <Typography
                  fontWeight={isTopicOfCurrentVideo ? 700 : 600}
                  fontSize={18} // 🔹 Increased font size for heading
                >
                  {topic}
                </Typography>
              </AccordionSummary>
                  ...
                  {vids.map((video) => {
                    ...
                    return (
                      <Box
                        key={video.shortcode}
                        onClick={() =>
                          handleVideoClick(video.shortcode as string)
                        }
                        component="li"
                        sx={{
                          mb: 1,
                          ...
                          fontSize: 17, // 🔹 Increased font size for video title
                          transition: 'all 0.2s',
                          '&:hover': {
